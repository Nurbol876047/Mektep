...
4. Қазақ тілінде, түсінікті етіп жаз. Ескерту: ЖАУАПТЫ ЕШҚАНДАЙ ЖАҒДАЙДА JSON ФОРМАТЫНДА БЕРМЕ! Тек қана әдемі, құрылымдалған Markdown мәтіні (тақырыпшалар, тізімдер, қалың қаріп) ретінде жаз.`;
